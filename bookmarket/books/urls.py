...
urlpatterns = [
    ...
    path('siparis/<int:pk>/', views.order_detail, name='order_detail'),
    path('siparis/<int:pk>/durum/', views.order_advance, name='order_advance'),
    path('siparis/<int:pk>/iptal/', views.order_cancel, name='order_cancel'),
